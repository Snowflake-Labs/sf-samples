...
SELECT
    ...
    TSM.ACTIVE_BYTES + TSM.TIME_TRAVEL_BYTES + TSM.FAILSAFE_BYTES + TSM.RETAINED_FOR_CLONE_BYTES AS TOTAL_BYTES ,
    --, t.bytes as table_logical_bytes --does not include Time Travel and Fail-safe usage. Just a nice comparison data point.

...
CREATE OR REPLACE VIEW QUERY_ACCELERATION_CC_CURRENCY_DAY COMMENT = 'Title: Query Acceleration Service (QAS) by Cost Center per day. Description: Analyze query acceleration service costs by cost center per day.'
as
WITH mr
AS (

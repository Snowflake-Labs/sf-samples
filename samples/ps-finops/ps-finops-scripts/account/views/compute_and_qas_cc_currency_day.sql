...
CREATE OR REPLACE VIEW COMPUTE_AND_QAS_CC_CURRENCY_DAY COMMENT = 'Title: Compute & Query Acceleration Service (QAS) Currency Usage by Cost Center per Day. Description: Analyze the major costs incurred in Snowflake Compute use. Does not account for extra cloud services fees above the 10% threshold.'
as
WITH mr
AS (

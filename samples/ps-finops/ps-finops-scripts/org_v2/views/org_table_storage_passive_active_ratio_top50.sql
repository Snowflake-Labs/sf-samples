...
CREATE OR REPLACE VIEW ORG_TABLE_STORAGE_PASSIVE_ACTIVE_RATIO_TOP50 COMMENT = 'Title: TOP 50 tables with passive storage greater than active storage. Description: Analyze the ratio of passive (Time Travel + Failsafe) to active storage for the top 50 worst tables.'
AS
SELECT  
    ACCOUNT_LOCATOR
    , REGION
...
FROM TABLE_STORAGE_DETAILED_ORG t

...
CREATE OR REPLACE VIEW ORGV1_SERVICECATEGORY_ACCOUNT_CURRENCY_DAY COMMENT = 'Title: Organizational Usage in currency by Category. Description: Organizational usage by category in currency.'
AS
SELECT
   USAGE_DATE,
   ACCOUNT_NAME,
   CONCAT_WS('-', REGION, ACCOUNT_NAME) AS REGION_ACCOUNT_NAME,
   RATING_TYPE AS USAGE_TYPE,

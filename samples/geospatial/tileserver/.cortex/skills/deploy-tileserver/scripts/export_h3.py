...
writing an array [{"h3": "<hex id>", "n": <count>}, ...]. No tiles, no tile
server - deck.gl renders these client-side.

Portable: Snowflake connection is the SNOWFLAKE_CONNECTION env var (active `snow`
CLI connection; falls back to the default connection). SOURCE_TABLE and H3_RES
are parameterized.
"""
import json
import os
